...
Under the hood it splits documents into chunks, converts them into vector embeddings using a local sentence transformer model, and finds the closest matches to your query
